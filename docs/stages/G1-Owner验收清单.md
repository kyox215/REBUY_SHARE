...
当前清单证据：本地静态、G1.2a 本地 workflow/等价验证、G1.3-0 本地预检、G1.3-1 provider/CLI/隔离预检、G1.3-2 高风险 Preview 执行独立审查与 2026-08-27 10:33:59 CEST Owner Gate 授权记录、G1.2b 真实 PR/Actions、PR #1 main merge 与远端只读设置核验；bad503 Preview 已真实完成并有脱敏 READY/health 证据；good200 本地验证已通过，good200 exact-head Actions 与独立 Preview deploy 尚未运行，在线回退仍缺
...
- 当前 G1 状态必须以 15 为准：G1.1 已完成，G1.2a 已完成，G1.2b 真实 PR/CI 已完成并通过 PR #1 merge commit 合并 `main`；main push 的 install/typecheck/lint/build 已成功，`integration/g1-2b` 仍保留；G1.3-0 本地预检与 G1.3-1 provider/CLI/部署前隔离预检已完成，G1.3-2 高风险独立审查已完成（原方案 NO-GO，修正后条件 GO 候选），Owner 于 2026-08-27 10:33:59 CEST 已批准修正版 G1.3 受控范围，bad503 Preview 已真实完成并有脱敏 READY/health 证据；good200 本地候选已实现且本批本地验证已通过、exact-head Actions 与独立 Preview deploy 尚未运行；在线回退仍缺；G1 Exit 未通过，G2-A0 不打开。
