...
G2-A1 当前执行中；B1 最小连接与配置/能力只读预检已完成；B2 本地 callback 安全基础完成候选，待独立安全复审与 action-time Owner/主代理 Gate。范围与验证见[B2 本地安全基础证据](../evidence/G2-A1/2026-08-28-b2-local-foundation/README.md)。真实 Auth/OAuth/SMTP/DB/Storage/session/user/MFA、部署和 Production Gate 继续 CLOSED；浏览器工具阻塞是残余风险。
