...
| P3 商家入驻与平台审核 | Runtime PASS / final independent review pending | bounded attempt #5 完整通过；exact candidate 最终复审待完成 | [P3 Gate](./P3-商家入驻与平台审核Gate.md)；[attempt #5](../evidence/P3/2026-09-03-runtime-attempt-5-pass/README.md)；[special review](../evidence/P3/2026-09-03-special-review/REVIEW.md) |

GOV-1、G0/P1、G1、G2-A0 与 E1 的历史完成/远端闭环事实仍以各自 evidence 和 [15 台账](../15-项目状态与阶段台账.md) 为准。E2a local email OTP 为 REVIEW GO；注册/登录 Auth contract `46/46` 且 local backend runtime 已通过，active browser Gate 仍待补。P2-L 已在 exact candidate 上取得独立 REVIEW GO，local Exit 关闭。P3 synthetic-only local Gate 已完成 attempt #5 runtime PASS，exact candidate final independent review 待完成。P4–P7、hosted/Production、main push/deploy 尚未完成。本索引只做导航，不复制详细记录。
