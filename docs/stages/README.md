...
| P3 商家入驻与平台审核 | Auditable runtime PASS / targeted review pending | attempt #6 保存有限工件与 manifests；只待关闭 evidence P2-E01 | [P3 Gate](./P3-商家入驻与平台审核Gate.md)；[attempt #6](../evidence/P3/2026-09-03-runtime-attempt-6-pass/README.md)；[final review](../evidence/P3/2026-09-03-final-independent-review/REVIEW.md) |

GOV-1、G0/P1、G1、G2-A0 与 E1 的历史完成/远端闭环事实仍以各自 evidence 和 [15 台账](../15-项目状态与阶段台账.md) 为准。E2a local email OTP 为 REVIEW GO；注册/登录 Auth contract `46/46` 且 local backend runtime 已通过，active browser Gate 仍待补。P2-L 已在 exact candidate 上取得独立 REVIEW GO，local Exit 关闭。P3 attempt #6 已完成可审计 runtime PASS，只待定向关闭 evidence `P2-E01`。P4–P7、hosted/Production、main push/deploy 尚未完成。本索引只做导航，不复制详细记录。
