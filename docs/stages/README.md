...
| 阶段 | 状态 | 证据级别 | 计划合同 |
|---|---|---|---|
| G1.2/G1.3 后续工程门 | G1.2a 已完成；G1.2b 待 Owner Gate；G1.3 未开始 | 本地静态/本地等价/规划 | [G1-工程底座与环境隔离](./G1-工程底座与环境隔离.md)；[G1.2a 本地 workflow/等价证据](../evidence/G1/2026-08-26-g1-2a-local-workflow/README.md)；[G1.2 CI 预检证据](../evidence/G1/2026-08-26-g1-2-ci-preflight/README.md)；[G1.2b-1 演练证据](../evidence/G1/2026-08-26-g1-2b-1-local-integration-rehearsal/README.md)；[G1.1 本地基线证据](../evidence/G1/2026-08-25-g1-1-local-baseline/README.md) |
